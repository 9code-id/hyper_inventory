...
mixin _$DailyReport {
  ...
  @JsonKey(name: 'report_date')
  set reportDate(String? value) => throw _privateConstructorUsedError;
...
class _$DailyReportImpl implements _DailyReport {
  _$DailyReportImpl(
      {@JsonKey(name: 'report_date') this.reportDate = null,
  ...
  @override
  String toString() {
    return 'DailyReport(reportDate: $reportDate, purchase: $purchase, sales: $sales)';
  }
...
abstract class _DailyReport implements DailyReport {
  factory _DailyReport(
      {@JsonKey(name: 'report_date') String? reportDate,
      @JsonKey(name: 'purchase') int? purchase,
      @JsonKey(name: 'sales') int? sales}) = _$DailyReportImpl;
